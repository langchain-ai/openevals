export const GROUNDED_IN_CONTEXT_PROMPT = `You are an expert data labeler evaluating model outputs for relevance to some context. Your task is to assign a score based on the following rubric:
