export const RETRIEVAL_HELPFULNESS_PROMPT = `You are an expert data labeler evaluating outputs for relevance to the input. Your task is to assign a score based on the following rubric:
