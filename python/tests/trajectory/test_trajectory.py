...
def test_trajectory_match_rejects_missing_outputs(match_mode):
    ...
    with pytest.raises(ValueError):
        evaluator(outputs=None, reference_outputs=reference_outputs)
    with pytest.raises(ValueError):
        evaluator(outputs=reference_outputs, reference_outputs=None)


@pytest.mark.langsmith
def test_trajectory_match_still_accepts_empty_outputs():
    ...
    result = evaluator(outputs=[], reference_outputs=reference_outputs)
    assert result["score"] is True
